...
import { Home, ArrowRight, Mail, Lock, User, AlertCircle } from 'lucide-react';
    ...
    return (
        <div className="auth-page" style={{
            ...
            <div style={{
                ...
                background: 'radial-gradient(circle, rgba(16, 185, 129, 0.1) 0%, transparent 60%)', zIndex: 0
            }} />
            <div style={{
            ...
            <div className="container" style={{ position: 'relative', zIndex: 1, display: 'flex', justifyContent: 'center' }}>
                ...
                >
                    <div className="text-center mb-8">
                        ...
                        <p style={{ color: 'var(--text-secondary)' }}>Join PhishGuard for advanced protection</p>
                    </div>
